...
public class StoreHouseController {
    ...
    public ProductDTO getItemById(@PathVariable(value = "item_id") int itemID) {
    ...
    public ProductDTO addItems(@PathVariable int id, @PathVariable Long amount) {
    ...
    public ProductDTO reserveItems(@PathVariable int id, @PathVariable Long amount) {
    ...
    public ProductDTO unreserveItems(@PathVariable int id, @PathVariable Long amount) {
